...
export default {
  ...
  head: {
    title: 'Visual SQL Tool | Free Online SQL Builder',
    meta: [
      { charset: 'utf-8' },
      { name: 'viewport', content: 'width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no' },
      { hid: 'description', name: 'description', content: 'Build SQL queries visually and skip the inconvenient parts of SQL with Visual SQL Tool, a free node-based solution for efficient SQL query building.' }
    ],
    link: [
