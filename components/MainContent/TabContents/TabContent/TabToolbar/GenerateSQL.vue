...
export default {
  ...
  methods: {
    ...
    generateSQL() {
      ...
      let treeObj = _app.databases[this.$state.project.sql.database].generateTree(
      ...
      let sqlObj = _app.databases[this.$state.project.sql.database].generateSQL(treeObj, sqlOptions)
