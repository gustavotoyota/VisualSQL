<template>
  <v-dialog max-width="651" v-model="$state.help.active" eager>
    <template v-slot:activator="{ on: dialog }">
      <ToolbarButton v-on="dialog" @click="onButtonClick" text>
        Help
      </ToolbarButton>
    </template>
    ...
    <v-card>
      ...
      <v-card-text style="padding: 0">
        <div style="padding: 12px 24px">
          VisualSQL is a free online tool for SQL query building. Below are the
        ...
        <div style="display: flex; height: 360px">
          ...
          >
            <div
              style="width: 460px; min-height: 331px;
      ...
      <v-card-actions>
        ...
        <v-btn color="primary" text @click="$state.help.active = false">
          Close
        </v-btn>
      </v-card-actions>
    </v-card>
