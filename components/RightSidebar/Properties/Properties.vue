  ...
  <div v-if="$getters.activeNode != null" class="mb-6">
    ...
    <div class="mx-5 mt-5">
      ...
      <v-text-field
        ...
        hide-details
        style="clear: right"
        title="Name used to reference this node from other nodes"
        class="mt-1 body-2"
        v-model="$getters.activeNode.props.name"
      >
      </v-text-field>
    </div>
    ...
    <div class="mx-5 mt-5">
      ...
      <v-textarea
        ...
        no-resize
        rows="2"
        title="Description of this node"
        v-model="$getters.activeNode.props.description"
      >
      </v-textarea>
    </div>
  ...
  <div v-else-if="$getters.activeLink != null">
    ...
    <div class="mx-5 mt-5">
      ...
      <v-text-field
        ...
        hide-details
        class="mt-1 body-2"
        v-model="$getters.activeLink.props.alias"
      >
      </v-text-field>
    </div>
  </div>
...
export default {
  ...
  watch: {
    ...
    "$getters.activeNode"(newNode, oldNode) {
      ...
      if (oldNode.props.tableName === $state.tableProps.searchInput) return;
